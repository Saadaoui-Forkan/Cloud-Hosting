      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row mb-6 md:mb-0">
            <Link
              href="/"
              className="text-darkBlue hover:text-accentCyan mx-2 mb-2 md:mb-0"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              href="/about"
              className="text-darkBlue hover:text-accentCyan mx-2"
            >
              About
            </Link>
          </div>
        ...
        <div className="mt-6 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Cloud Hosting. All rights
            reserved.
          </p>
        </div>
      </div>
